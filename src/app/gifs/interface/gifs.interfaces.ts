export interface SearchGIFResp {
    data:       Gif[];
...
export class Convert {
    public static toSearchGIFResp(json: string): SearchGIFResp {
        return cast(JSON.parse(json), r("SearchGIFResp"));
    }

    public static searchGIFRespToJson(value: SearchGIFResp): string {
        return JSON.stringify(uncast(value, r("SearchGIFResp")), null, 2);
    }
}
